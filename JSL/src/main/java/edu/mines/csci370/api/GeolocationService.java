...
public class GeolocationService {
  ...
  public interface Iface {
     ...
     * @param tBox
     */
    public List<Feature> getFeatures(double lBox, double rBox, double bBox, double tBox) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getFeatures(double lBox, double rBox, double bBox, double tBox, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<Feature> getFeatures(double lBox, double rBox, double bBox, double tBox) throws org.apache.thrift.TException
    {
      send_getFeatures(lBox, rBox, bBox, tBox);
      return recv_getFeatures();
    }

    public void send_getFeatures(double lBox, double rBox, double bBox, double tBox) throws org.apache.thrift.TException
    {
    ...
    public List<Feature> recv_getFeatures() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getFeatures(double lBox, double rBox, double bBox, double tBox, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getFeatures_call method_call = new getFeatures_call(lBox, rBox, bBox, tBox, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class getFeatures_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private double bBox;
      private double tBox;
      public getFeatures_call(double lBox, double rBox, double bBox, double tBox, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getFeatures<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getFeatures_args> {
      ...
      public getFeatures_result getResult(I iface, getFeatures_args args) throws org.apache.thrift.TException {
        getFeatures_result result = new getFeatures_result();
        result.success = iface.getFeatures(args.lBox, args.rBox, args.bBox, args.tBox);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getFeatures<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getFeatures_args, List<Feature>> {
      public getFeatures() {
        super("getFeatures");
      }
      ...
      public AsyncMethodCallback<List<Feature>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<Feature>>() { 
          public void onComplete(List<Feature> o) {
            getFeatures_result result = new getFeatures_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getFeatures_args args, org.apache.thrift.async.AsyncMethodCallback<List<Feature>> resultHandler) throws TException {
        iface.getFeatures(args.lBox, args.rBox, args.bBox, args.tBox,resultHandler);
      }
    }
  ...
  public static class getFeatures_args implements org.apache.thrift.TBase<getFeatures_args, getFeatures_args._Fields>, java.io.Serializable, Cloneable, Comparable<getFeatures_args>   {
    ...
    public void unsetLBox() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __LBOX_ISSET_ID);
    }

    /** Returns true if field lBox is set (has been assigned a value) and false otherwise */
    public boolean isSetLBox() {
      return EncodingUtils.testBit(__isset_bitfield, __LBOX_ISSET_ID);
    }

    public void setLBoxIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __LBOX_ISSET_ID, value);
    }
    ...
    public void unsetRBox() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __RBOX_ISSET_ID);
    }

    /** Returns true if field rBox is set (has been assigned a value) and false otherwise */
    public boolean isSetRBox() {
      return EncodingUtils.testBit(__isset_bitfield, __RBOX_ISSET_ID);
    }

    public void setRBoxIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __RBOX_ISSET_ID, value);
    }
    ...
    public void unsetBBox() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __BBOX_ISSET_ID);
    }

    /** Returns true if field bBox is set (has been assigned a value) and false otherwise */
    public boolean isSetBBox() {
      return EncodingUtils.testBit(__isset_bitfield, __BBOX_ISSET_ID);
    }

    public void setBBoxIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __BBOX_ISSET_ID, value);
    }
    ...
    public void unsetTBox() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TBOX_ISSET_ID);
    }

    /** Returns true if field tBox is set (has been assigned a value) and false otherwise */
    public boolean isSetTBox() {
      return EncodingUtils.testBit(__isset_bitfield, __TBOX_ISSET_ID);
    }

    public void setTBoxIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TBOX_ISSET_ID, value);
    }
    ...
    public Object getFieldValue(_Fields field) {
      switch (field) {
      case L_BOX:
        return Double.valueOf(getLBox());

      case R_BOX:
        return Double.valueOf(getRBox());

      case B_BOX:
        return Double.valueOf(getBBox());

      case T_BOX:
        return Double.valueOf(getTBox());
    ...
    public int compareTo(getFeatures_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetLBox()).compareTo(other.isSetLBox());
      if (lastComparison != 0) {
      ...
      lastComparison = Boolean.valueOf(isSetRBox()).compareTo(other.isSetRBox());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetRBox()) {
      ...
      lastComparison = Boolean.valueOf(isSetTBox()).compareTo(other.isSetTBox());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetTBox()) {
  ...
  public static class getFeatures_result implements org.apache.thrift.TBase<getFeatures_result, getFeatures_result._Fields>, java.io.Serializable, Cloneable, Comparable<getFeatures_result>   {
    ...
    public getFeatures_result(getFeatures_result other) {
      if (other.isSetSuccess()) {
        List<Feature> __this__success = new ArrayList<Feature>(other.success.size());
    ...
    public getFeatures_result setSuccess(List<Feature> success) {
      this.success = success;
      return this;
    }

'''Serious module to cut the feature. This module uses s2 library instead of s2sphere.
Rigid test not performed, so we assume this is usable. The fallback library is renamed as
slicing_s2sphere. Main interface: slice_feature'''
